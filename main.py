...
API_ID = int(os.environ.get("API_ID", 24677063))
API_HASH = os.environ.get("API_HASH", "9145f97526b15fec73efdb429c0d3575")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7773090510:AAH2JwnoTUA0AIhDCIo7cWfP5YLFesiD3X8")
